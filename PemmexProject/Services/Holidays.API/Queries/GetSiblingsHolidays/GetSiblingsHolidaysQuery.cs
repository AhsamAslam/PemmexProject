...
namespace Holidays.API.Queries.GetSiblingsHolidays
{
    public class GetSiblingsHolidaysQuery : IRequest<List<EmployeeHolidayDto>>
    {
        public string[] employeeIdentifiers { get; set; }
        public string organizationIdentifier { get; set; }
    }
    public class GetSiblingsHolidaysQueryHandeler : IRequestHandler<GetSiblingsHolidaysQuery, List<EmployeeHolidayDto>>
    {
        ...
        public GetSiblingsHolidaysQueryHandeler(IApplicationDbContext context, 
            IDateTime dateTime, IMapper mapper,
            IConfiguration configuration, IHolidaySettingRepository holidaySettingContext,
        ...
        public async Task<List<EmployeeHolidayDto>> Handle(GetSiblingsHolidaysQuery request, CancellationToken cancellationToken)
        {
            try
            {
