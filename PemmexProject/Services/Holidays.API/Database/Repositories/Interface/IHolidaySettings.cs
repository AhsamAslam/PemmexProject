...
namespace Holidays.API.Repositories.Interface
{
    public interface IHolidaySettings
    {
        ...
        Task<IEnumerable<HolidaySettings>> GetHolidaySettingsByOrganizationIdentifier(string OrganizationIdentifier);
        Task<HolidaySettings> GetHolidaySettingsByBusinessIdentifier(string BusinessIdentifier);
