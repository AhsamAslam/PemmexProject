...
namespace TaskManager.API.NotificationHub
{
    public class NotificationRepository :INotificationRepository
    {
        ...
        public async Task<int> AddNotifications(Notifications notifications)
        {
            try
            {
        ...
        public async Task<List<Notifications>> GetAllNotification(string EmployeeId)
        {
            try
            {
        ...
        public async Task<int> SaveNotification(Notifications notifications, CancellationToken cancellationToken)
        {
            try
            {
