...
using Organization.API.Queries.GetSubordinates;
...
namespace Organization.API.Controllers
{
    ...
    public class Organization : ApiControllerBase
    {
        private readonly IWebHostEnvironment _hostingEnvironment;
        private readonly IFileUploadService _fileUploadService;
        private readonly IDateTime _dateTime;
        private readonly ILogService _logService;
        public Organization(IWebHostEnvironment hostEnvironment, 
                            ...
                            if (count ==2 )
                            {
                                for (int r = 0; r < sheet.Dimension.End.Row + 1; r++)
                                {
                                    if (r > 3 && !string.IsNullOrEmpty(sheet.Cells[r, 6].Value.ToString2()))
                                    {
                                        ...
                                        emp_req.JobFunction = sheet.Cells[r, 60].Value.ToString2();
        ...
        public async Task<ActionResult<ResponseMessage>> OrganizationEmployees()
        {
            try
            {
                var data = await Mediator.Send(new GetOrganizationEmployeesQuery { Id = CurrentUser.OrganizationIdentifier });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<ResponseMessage>> GetAsync()
        {
            try
            {
                var data = await Mediator.Send(new GetOrganizationQuery { Id = CurrentUser.OrganizationIdentifier });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpGet]
        [Route("employeesList/{id}")]
        public async Task<ActionResult<ResponseMessage>> EmployeesAsync(string id)
        {
            try
            {
                var data = await Mediator.Send(new GetAllEmployees { Id = id });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpGet]
        [Route("employees/{id}")]
        public async Task<ActionResult<ResponseMessage>> GetEmployeeAsync(string id)
        {
            try
            {
                var data = await Mediator.Send(new GetEmployeeQuery{Id = id});
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpGet]
        [Route("employeeByIdentifier/{id}")]
        public async Task<ActionResult<ResponseMessage>> GetEmployeeByIdentifierAsync(string id)
        {
            try
            {
                var data = await Mediator.Send(new GetEmployeeByIdentifierQuery { Id = id });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpGet]
        [Route("employeesByIdentifiers")]
        public async Task<ActionResult<ResponseMessage>> GetEmployeesByIdentifiersAsync([FromQuery] string[] Identifiers)
        {
            try
            {
                var data = await Mediator.Send(new GetEmployeeByIdentifiersQuery { Identifiers = Identifiers });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpPost]
        [Route("employees")]
        public async Task<ActionResult<ResponseMessage>> EmployeesAsync(EmployeeRequest employee)
        {
            try
            {
                
                var data = await Mediator.Send(new CreateEmployeeCommand { employee = employee });
                return new ResponseMessage(true, EResponse.OK, AppConstants._employeeCreated, data);
        ...
        [HttpPut]
        [Route("employees/{id}")]
        public async Task<ActionResult<ResponseMessage>> EmployeesAsync(EmployeeRequest employee,string id)
        {
            try
            {
                var data = await Mediator.Send(new UpdateEmployeeCommand { employee = employee,Id = id });
        ...
        [HttpDelete]
        [Route("employees/{id}")]
        public async Task<ActionResult<ResponseMessage>> DeleteAsync(string id)
        {
            try
            {
                var data = await Mediator.Send(new DeleteEmployeeCommand { Id = id });
        ...
        [HttpGet]
        [Route("managers")]
        public async Task<ActionResult<ResponseMessage>> GetManagersAsync()
        {
            try
            {
                 var data = await Mediator.Send(new GetManagersQuery { Id = CurrentUser.OrganizationIdentifier});
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<List<EmployeeResponse>>> GetTeamMembersAsync(string costCenterIdentifier)
        {
            try
            {
        ...
        [HttpGet]
        [Route("team/{costCenterIdentifier}")]
        public async Task<ActionResult<ResponseMessage>> GetcostCenterIdentifier(string costCenterIdentifier)
        {
            try
            {
                var data = await Mediator.Send(new GetcostCenterIdentifierQuery { costCenterIdentifier = costCenterIdentifier });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<ResponseMessage>> GetcostCenterIdentifiers(string businessIdentifier)
        {
            try
            {
                var data = await Mediator.Send(new GetcostCenterIdentifiersQuery { organizationIdentifier = businessIdentifier });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpGet]
        [Route("costCenterIdentifierTree")]
        public async Task<ActionResult<ResponseMessage>> GetcostCenterIdentifiersTree(string costIdentifier)
        {
            try
            {
                var data = await Mediator.Send(new GetcostCenterIdentifiersTreeQuery { costCenterIdentifier = costIdentifier });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        [HttpPost]
        [Route("costCenterIdentifier")]
        public async Task<ActionResult<ResponseMessage>> SavecostCenterIdentifiers(CostCenterRequest costCenterRequest)
        {
            try
            {
                var data = await Mediator.Send(new CreateCostCenterCommand { costCenterRequest = costCenterRequest });
                return new ResponseMessage(true, EResponse.OK, null, data);
            }
            catch (Exception e)
            {
        ...
        public async Task<ActionResult<List<spGetEmployeeTreeForManagerDto>>> Subordinates(string id)
        {
            try
            {
                return await Mediator.Send(new GetsubordinatesQuery { Id = id });
            }
            catch (Exception e)
            {
                throw;
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("AllBusinessEmployees/{id}")]
        public async Task<ActionResult<List<EmployeeResponse>>> AllBusinessEmployees(string id)
        {
            try
            {
                return await Mediator.Send(new GetAllBusinessEmployeesQuery { Id = id });
            }
            catch (Exception e)
            {
                throw;
        ...
        [AllowAnonymous]
        [HttpGet]
        [Route("AllOrganizationEmployees/{id}")]
        public async Task<ActionResult<List<EmployeeResponse>>> AllOrganizationEmployees(string id)
        {
            try
            {
                return await Mediator.Send(new GetAllOrganizationEmployeesQuery { Id = id });
            }
            catch (Exception e)
            {
                throw;
        ...
        [HttpGet]
        [Route("Businesses/{id}")]
        public async Task<ActionResult<List<BusinessVM>>> Businesses(string id)
        {
            try
            {
                return await Mediator.Send(new GetAllBusinessesQuery { Id = id });
            }
            catch (Exception e)
            {
                throw;
