...
namespace PemmexUnitTest.Holidays.API
{
    [TestClass]
    public class HolidaysControllerTestCase
    {
        ...
        {
            holiday = new Holiday(_logService);
        }
        ...
        //Task<ActionResult<ResponseMessage>> result = holiday.sa(saveHolidayCommand) as Task<ActionResult<ResponseMessage>>;
        ...
        public void UserEarnedHolidays_Test1()
        {
            ...
            Task<ActionResult<int>> result = holiday.UserEarnedHolidays("2233", "") as Task<ActionResult<int>>;
        ...
        public void UserPlannedHolidays_Test1()
        {
            ...
            Task<ActionResult<int>> result = holiday.UserPlannedHolidays("2233", "") as Task<ActionResult<int>>;
        ...
        public void UserRemainingHolidays_Test1()
        {
            ...
            Task<ActionResult<int>> result = holiday.UserRemainingHolidays("2233","", "USA") as Task<ActionResult<int>>;
        ...
        public void UserAvailedHolidays_Test1()
        {
            ...
            Task<ActionResult<int>> result = holiday.UserAvailedHolidays("2233", "", "USA") as Task<ActionResult<int>>;
